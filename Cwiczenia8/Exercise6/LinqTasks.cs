...
namespace Exercise6
{
    public static class LinqTasks
    {
        ...
        public static IEnumerable<object> Task10()
        {
            var methodSyntax = Emps
                ...
                .Union(Emps.Select(e => new {Ename = "Brak wartości",
                    Job = (string)null,
        ...
        {
            IEnumerable<Emp> result = Emps.FilterBySubordinatesAndSort();
            return result;
        }
        ...
        public static IEnumerable<Dept> Task14()
        {
            var result = Depts.GroupJoin(Emps,
                    dept => dept.Deptno,
                    emp => emp.Deptno,
                    (dept, empGroup) => new { Department = dept, EmployeeCount = empGroup.Count() })
                .Where(join => join.EmployeeCount == 5 || join.EmployeeCount == 0)
                .Select(join => join.Department)
    ...
    public static class CustomExtensionMethods
    {
        ...
        public static IEnumerable<Emp> FilterBySubordinatesAndSort(this IEnumerable<Emp> employees)
        {
            var result = employees.Where(emp => employees.Any(subordinate => subordinate.Mgr == emp))
